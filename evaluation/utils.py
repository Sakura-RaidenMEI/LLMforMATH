...
PROMPT_TEMPLATES = {
    ...
    "cot": ("You are good at math. Reason the math question step by step. Question: {input}\nAnswer: ", "{output}", "\n\n\n"),
    "pal": ("Question: {input}\n\n", "{output}", "\n---\n"),
    ...
    "self-refine": (
        "## Question: {input}\n\nInitial Answer:",
        "{output}\n\nCritique(ONLY ONE ATTEMPT ALLOWED).: Identify potential flaws in the answer above.\nRevised Answer and put your final answer within \\boxed{{}},do not repeat your answer, only revised ONCE.\n ",
        "\n---\n"
    ),
    "self-consistency": (
        "## Question: {input}\n\nLet's think step by step. Provide 5 different reasoning paths and put all your answer within one \\boxed{{}}. Each path better use different methods, at least two independent methods in total.\n",
        "Path {i}: {output}",
        "\n---\n"
    ),
}
